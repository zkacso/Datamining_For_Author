...
import hu.university.io.CorpusIO;
...
public class Main {
    ...
    static double leastFrequentWordCutPercentage = 0.0;
    static double mostFrequentWordCutPercentage = 0.05;
    static int MaxNumberOfWords = 5000;
    static int index = -1;
    static int sizeOfTrainingSet = 1;
